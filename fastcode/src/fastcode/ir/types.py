...
def resolution_to_confidence(resolution_state: str | None) -> str:
    return {
        "anchored": "precise",
        "semantic": "precise",
...
def _resolution_to_confidence(resolution_state: str | None) -> str:
    return resolution_to_confidence(resolution_state)
