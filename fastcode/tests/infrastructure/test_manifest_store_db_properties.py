...
class TestManifestChain:
    ...
    @pytest.mark.edge
    def test_chain_with_custom_status_property(self):
...
class TestPublishReturnStructure:
    ...
    @pytest.mark.edge
    def test_published_at_is_iso_format_property(self):
...
class TestMissingLookups:
    @pytest.mark.edge
    def test_get_branch_manifest_unknown_returns_none_property(self):
        """EDGE: get_branch_manifest returns None for unknown repo/ref."""
        store = _make_store()
        assert store.get_branch_manifest("nonexistent", "main") is None

    @pytest.mark.edge
    def test_get_snapshot_manifest_unknown_returns_none_property(self):
    ...
    @pytest.mark.edge
    def test_lookup_after_unpublished_repo_property(self):
...
class TestDifferentRefsIndependent:
    ...
    @pytest.mark.edge
    def test_same_snapshot_different_refs_property(self):
