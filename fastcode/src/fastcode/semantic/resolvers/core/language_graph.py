...
class JavaSemanticResolver(GraphBackedSemanticResolver):
    ...
    extractor_name = "fastcode.semantic.resolvers.languages.java"
...
class GoSemanticResolver(GraphBackedSemanticResolver):
    ...
    extractor_name = "fastcode.semantic.resolvers.languages.go"
...
class RustSemanticResolver(GraphBackedSemanticResolver):
    ...
    extractor_name = "fastcode.semantic.resolvers.languages.rust"
...
class CSharpSemanticResolver(GraphBackedSemanticResolver):
    ...
    extractor_name = "fastcode.semantic.resolvers.languages.csharp"
...
class ZigSemanticResolver(GraphBackedSemanticResolver):
    ...
    extractor_name = "fastcode.semantic.resolvers.languages.zig"
...
class FortranSemanticResolver(GraphBackedSemanticResolver):
    ...
    extractor_name = "fastcode.semantic.resolvers.languages.fortran"
...
class JuliaSemanticResolver(GraphBackedSemanticResolver):
    ...
    extractor_name = "fastcode.semantic.resolvers.languages.julia"
