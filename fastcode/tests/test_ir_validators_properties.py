...
class TestValidateSnapshotProperties:
    ...
    @settings(max_examples=30)
    @pytest.mark.basic
    def test_valid_occurrences_no_errors_property(self, doc_id: str, path: str, sym_id: str):
    ...
    @settings(max_examples=20)
    @pytest.mark.edge
    def test_duplicate_doc_ids_always_flagged_property(self, doc_id: str, path: str, n: int):
    ...
    @settings(max_examples=20)
    @pytest.mark.edge
    def test_edge_dangling_refs_always_flagged_property(self, bad_src: str, bad_dst: str):
    ...
    @settings(max_examples=20)
    @pytest.mark.basic
    def test_edge_src_can_be_doc_or_sym_property(self, doc_id: str, path: str, sym_id: str):
