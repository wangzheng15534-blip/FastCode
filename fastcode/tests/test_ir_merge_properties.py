...
class TestMergeIrProperties:
    ...
    @settings(max_examples=50)
    @pytest.mark.basic
    def test_edge_coexistence_property(self, ast_edges: list[IREdge], scip_edges: list[IREdge]):
    ...
    @pytest.mark.edge
    def test_merge_retargets_and_deduplicates_semantically_identical_attachments_property(self):
