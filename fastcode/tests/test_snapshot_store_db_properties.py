...
class TestSnapshotsTableConstraints:
    ...
    @pytest.mark.basic
    def test_duplicate_snapshot_id_upserts_property(self, repo: str, commit: str, branch: str):
    ...
    @settings(max_examples=10)
    @pytest.mark.edge
    def test_upsert_preserves_latest_data_property(self, repo: str, commit: str, branch: str):
...
class TestSnapshotRefsConstraints:
    ...
    @settings(max_examples=15)
    @pytest.mark.basic
    def test_duplicate_ref_does_not_raise_property(self, repo: str, commit: str, branch: str):
    ...
    @settings(max_examples=10)
    @pytest.mark.basic
    def test_resolve_snapshot_for_ref_property(self, repo: str, commit: str, branch: str):
...
class TestScipArtifactsTable:
    ...
    @settings(max_examples=10)
    @pytest.mark.basic
    def test_scip_artifact_fields_roundtrip_property(self, repo: str, commit: str, branch: str):
...
class TestLargeMetadataRoundtrip:
    ...
    @pytest.mark.edge
    def test_large_metadata_roundtrip_property(self, repo: str, commit: str, branch: str):
...
class TestArtifactKeyGeneration:
    ...
    @settings(max_examples=20)
    @pytest.mark.basic
    def test_different_snapshot_ids_different_keys_property(self, snap_id1: Any, snap_id2: Any):
...
class TestFindbyArtifactKey:
    ...
    @settings(max_examples=10)
    @pytest.mark.basic
    def test_find_by_artifact_key_after_save_property(self, repo: str, commit: str, branch: str):
...
class TestSnapshotRecordFields:
    ...
    @settings(max_examples=10)
    @pytest.mark.basic
    def test_snapshot_record_has_all_fields_property(self, repo: str, commit: str, branch: str):
    ...
    @settings(max_examples=10)
    @pytest.mark.basic
    def test_ir_path_points_to_real_file_property(self, repo: str, commit: str, branch: str):
