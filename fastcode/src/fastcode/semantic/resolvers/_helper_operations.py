...
from ...utils.json import load_json_object, write_json_object_atomic
from ..resolution import ToolDiagnostic
from ._resolver_support import _normalize_path, validate_helper_paths
...
class SemanticHelperOperations:
    ...
    def helper_path(spec: SemanticHelperSpec) -> Path:
        return Path(__file__).with_name(spec.helper_filename)
