...
class TestResolveSymbol:
    @pytest.mark.basic
    def test_local_resolution_property(self):
    ...
    @pytest.mark.basic
    def test_imported_resolution_property(self):
    ...
    @pytest.mark.edge
    def test_no_imports_returns_none_for_external_property(self):
...
class TestMatchesImport:
    @pytest.mark.basic
    def test_direct_name_match_property(self):
    ...
    @pytest.mark.basic
    def test_alias_match_property(self):
    ...
    @pytest.mark.basic
    def test_module_prefix_match_property(self):
    ...
    @pytest.mark.edge
    def test_empty_import_info_property(self):
        """EDGE: empty import info returns False."""
        resolver = _make_resolver()
        assert resolver._matches_import("foo", {}) is False

    @pytest.mark.edge
    def test_member_prefix_match_property(self):
...
class TestGetModulePathByFileId:
    @pytest.mark.basic
    def test_known_file_id_property(self):
...
class TestGetCurrentModulePathForImports:
    ...
    @pytest.mark.edge
    def test_unknown_file_returns_empty_property(self):
...
class TestGetResolutionStats:
    ...
    @pytest.mark.edge
    def test_empty_stats_property(self):
    ...
    @pytest.mark.edge
    def test_resolve_always_returns_none_or_str_property(self, symbol: str):
