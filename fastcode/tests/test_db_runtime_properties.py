...
class TestInit:
    @pytest.mark.basic
    def test_sqlite_memory_creation_property(self) -> None:
    ...
    @pytest.mark.basic
    def test_backend_lowercased_property(self) -> None:
        rt = DBRuntime(backend="SQLite", sqlite_path=":memory:")
        assert rt.backend == "sqlite"

    @pytest.mark.basic
    def test_none_backend_defaults_to_sqlite_property(self) -> None:
        rt = DBRuntime(backend=None, sqlite_path=":memory:")
        assert rt.backend == "sqlite"

    @pytest.mark.basic
    def test_empty_backend_defaults_to_sqlite_property(self) -> None:
        rt = DBRuntime(backend="", sqlite_path=":memory:")
        assert rt.backend == "sqlite"

    @pytest.mark.basic
    def test_pool_min_max_cast_to_int_property(self) -> None:
        rt = DBRuntime(
    ...
    def test_sqlite_without_path_raises_property(self) -> None:
    ...
    @pytest.mark.negative
    def test_sqlite_none_path_raises_property(self) -> None:
        """Line 61: None sqlite_path raises."""
        with pytest.raises(RuntimeError, match="sqlite backend requires sqlite_path"):
            DBRuntime(backend="sqlite", sqlite_path=None)

    @pytest.mark.negative
    def test_sqlite_empty_path_raises_property(self) -> None:
        """Line 61: empty string sqlite_path raises."""
        with pytest.raises(RuntimeError, match="sqlite backend requires sqlite_path"):
            DBRuntime(backend="sqlite", sqlite_path="")

    @pytest.mark.negative
    def test_postgres_without_dsn_raises_property(self) -> None:
    ...
    @pytest.mark.negative
    def test_postgres_empty_dsn_raises_property(self) -> None:
    ...
    @pytest.mark.edge
    def test_postgres_pool_not_available_warns_property(
...
class TestFromStorageConfig:
    @pytest.mark.basic
    def test_defaults_to_sqlite_property(self) -> None:
        rt = DBRuntime.from_storage_config(sqlite_path=":memory:", storage_cfg=None)
        assert rt.backend == "sqlite"

    @pytest.mark.basic
    def test_config_backend_overrides_property(self) -> None:
    ...
    @pytest.mark.basic
    def test_pool_settings_from_config_property(self) -> None:
        rt = DBRuntime.from_storage_config(
            sqlite_path=":memory:",
    ...
    @pytest.mark.basic
    def test_env_backend_override_property(self, monkeypatch: pytest.MonkeyPatch) -> None:
...
class TestAdaptSql:
    @pytest.mark.basic
    def test_sqlite_passthrough_property(self) -> None:
        rt = _make_sqlite_runtime()
    ...
    @pytest.mark.basic
    def test_sqlite_never_transforms_property(self, prefix: str, suffix: str) -> None:
        rt = _make_sqlite_runtime()
        sql = f"{prefix}?{suffix}"
        assert rt.adapt_sql(sql) == sql

    @pytest.mark.basic
    def test_postgres_replaces_placeholders_property(self) -> None:
    ...
    @pytest.mark.basic
    def test_postgres_adapt_n_placeholders_property(self, n: int) -> None:
    ...
    @pytest.mark.basic
    def test_postgres_no_placeholders_unchanged_property(self) -> None:
...
class TestConnect:
    @pytest.mark.basic
    def test_connect_yields_sqlite_connection_property(self) -> None:
        rt = _make_sqlite_runtime()
        with rt.connect() as conn:
            assert isinstance(conn, sqlite3.Connection)

    @pytest.mark.basic
    def test_connect_sets_wal_mode_property(self) -> None:
        rt = _make_sqlite_runtime()
        with rt.connect() as conn:
    ...
    @pytest.mark.basic
    def test_connect_sets_synchronous_normal_property(self) -> None:
        rt = _make_sqlite_runtime()
        with rt.connect() as conn:
    ...
    @pytest.mark.basic
    def test_connect_sets_foreign_keys_property(self) -> None:
        rt = _make_sqlite_runtime()
        with rt.connect() as conn:
    ...
    @pytest.mark.basic
    def test_connect_sets_busy_timeout_property(self) -> None:
        rt = _make_sqlite_runtime()
        with rt.connect() as conn:
    ...
    @pytest.mark.negative
    def test_connect_closes_after_context_property(self) -> None:
    ...
    @pytest.mark.negative
    def test_connect_cleanup_on_exception_property(self) -> None:
    ...
    @pytest.mark.basic
    def test_separate_memory_connections_are_isolated_property(self) -> None:
        rt = _make_sqlite_runtime()
...
class TestExecute:
    @pytest.mark.basic
    def test_execute_basic_query_property(self) -> None:
        rt = _make_sqlite_runtime()
        with rt.connect() as conn:
    ...
    @pytest.mark.basic
    def test_execute_create_and_insert_property(self) -> None:
        rt = _make_sqlite_runtime()
        with rt.connect() as conn:
    ...
    @pytest.mark.basic
    def test_execute_returns_cursor_property(self) -> None:
        rt = _make_sqlite_runtime()
        with rt.connect() as conn:
    ...
    @pytest.mark.basic
    def test_execute_empty_params_default_property(self) -> None:
        rt = _make_sqlite_runtime()
        with rt.connect() as conn:
    ...
    @settings(max_examples=30)
    @pytest.mark.basic
    def test_execute_roundtrip_property(self, name: str, value: int) -> None:
        rt = _make_sqlite_runtime()
        with rt.connect() as conn:
    ...
    @settings(max_examples=30)
    @pytest.mark.basic
    def test_execute_various_types_property(self, values: list[Any]) -> None:
        rt = _make_sqlite_runtime()
        with rt.connect() as conn:
            ncols = len(values)
            if ncols == 0:
    ...
    @pytest.mark.negative
    def test_execute_bad_sql_raises_property(self) -> None:
        rt = _make_sqlite_runtime()
        with rt.connect() as conn, pytest.raises(sqlite3.OperationalError):
            rt.execute(conn, "SELECT * FROM nonexistent_table")

    @pytest.mark.negative
    def test_execute_duplicate_primary_key_raises_property(self) -> None:
        rt = _make_sqlite_runtime()
        with rt.connect() as conn:
...
class TestBeginWrite:
    @pytest.mark.basic
    def test_begin_write_sqlite_property(self) -> None:
    ...
    @pytest.mark.edge
    def test_begin_write_rollback_restores_property(self) -> None:
        rt = _make_sqlite_runtime()
        with rt.connect() as conn:
            conn.execute("CREATE TABLE t (x INTEGER)")
            rt.begin_write(conn)
...
class TestConnectionPooling:
    ...
    @pytest.mark.basic
    def test_sequential_connections_property(self, n: int) -> None:
        rt = _make_sqlite_runtime()
        for i in range(n):
            with rt.connect() as conn:
    ...
    @pytest.mark.basic
    def test_nested_connections_property(self) -> None:
...
class TestRollbackBehavior:
    @pytest.mark.negative
    def test_constraint_violation_no_corruption_property(self) -> None:
        rt = _make_sqlite_runtime()
        with rt.connect() as conn:
    ...
    @pytest.mark.negative
    def test_invalid_sql_no_crash_property(self) -> None:
        rt = _make_sqlite_runtime()
        with rt.connect() as conn:
    ...
    @pytest.mark.negative
    def test_nonexistent_table_no_corruption_property(self) -> None:
        rt = _make_sqlite_runtime()
        with rt.connect() as conn:
    ...
    @pytest.mark.basic
    def test_rollback_restores_state_property(self) -> None:
        rt = _make_sqlite_runtime()
        with rt.connect() as conn:
            conn.execute("CREATE TABLE t (x INTEGER)")
            conn.execute("INSERT INTO t VALUES (1)")
    ...
    @pytest.mark.basic
    def test_commit_persists_property(self) -> None:
        rt = _make_sqlite_runtime()
        with rt.connect() as conn:
            conn.execute("CREATE TABLE t (x INTEGER)")
            rt.begin_write(conn)
    ...
    @pytest.mark.negative
    def test_connection_closed_after_exception_property(self) -> None:
        rt = _make_sqlite_runtime()
        conn: Any = None
        try:
            with rt.connect() as conn:
...
class TestSchema:
    @pytest.mark.basic
    def test_join_query_property(self) -> None:
        rt = _make_sqlite_runtime()
        with rt.connect() as conn:
    ...
    @pytest.mark.basic
    def test_dynamic_table_creation_property(
    ...
    @pytest.mark.basic
    def test_row_factory_dict_like_property(self) -> None:
        rt = _make_sqlite_runtime()
        with rt.connect() as conn:
...
class TestDbRuntimeEdgeExtras:
    @pytest.mark.negative
    def test_execute_invalid_sql_property(self) -> None:
        rt = _make_sqlite_runtime()
        with rt.connect() as conn, pytest.raises(Exception, match=r".*"):
            rt.execute(conn, "INVALID SQL STATEMENT")

    @pytest.mark.edge
    def test_empty_query_result_property(self) -> None:
        rt = _make_sqlite_runtime()
        with rt.connect() as conn:
            conn.execute("CREATE TABLE t (x INTEGER)")
            cur = rt.execute(conn, "SELECT * FROM t")
    ...
    @pytest.mark.edge
    def test_rollback_on_exception_property(self) -> None:
        rt = _make_sqlite_runtime()
        with rt.connect() as conn:
            conn.execute("CREATE TABLE t (x INTEGER)")
            conn.execute("INSERT INTO t VALUES (1)")
    ...
    @pytest.mark.edge
    def test_null_values_stored_property(self) -> None:
        rt = _make_sqlite_runtime()
        with rt.connect() as conn:
    ...
    @pytest.mark.edge
    def test_adapt_sql_postgres_replaces_placeholders_property(self) -> None:
    ...
    @pytest.mark.edge
    def test_adapt_sql_sqlite_passthrough_property(self) -> None:
        rt = _make_sqlite_runtime()
