...
class TestProjectionScope:
    ...
    @settings(max_examples=15)
    @pytest.mark.basic
    def test_scope_with_query_property(self, kind: bool, snap_id: str, key: str, query: str):
    ...
    @pytest.mark.edge
    def test_scope_default_filters_empty_property(self, kind: bool, snap_id: str, key: str):
