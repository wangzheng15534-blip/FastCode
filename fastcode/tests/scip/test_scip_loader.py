...
class TestScipKindToStr:
    ...
    def test_generated_protobuf_kind_values(self):
        """REGRESSION: generated SCIP enum values are sparse, not 1-based."""
        assert _scip_kind_to_str(17) == "function"
        assert _scip_kind_to_str(26) == "method"
        assert _scip_kind_to_str(7) == "class"
