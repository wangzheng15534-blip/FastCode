"""Property-based and edge tests for SnapshotSymbolIndex."""
...
@pytest.mark.edge
def test_has_snapshot_false_for_unknown():
...
@pytest.mark.edge
def test_canonicalize_symbol_missing_snapshot():
...
@pytest.mark.edge
def test_canonicalize_symbol_missing_symbol():
...
@pytest.mark.edge
def test_get_aliases_missing_snapshot():
...
@pytest.mark.edge
def test_get_aliases_missing_symbol():
...
@pytest.mark.edge
def test_resolve_symbol_missing_snapshot():
...
@pytest.mark.edge
def test_resolve_symbol_no_params():
...
@pytest.mark.edge
def test_resolve_symbol_all_params_none_match():
...
@pytest.mark.edge
def test_register_snapshot_empty_symbols():
...
@pytest.mark.edge
def test_register_overwrites_previous_snapshot():
...
@pytest.mark.edge
def test_snapshot_symbol_maps_defaults():
...
@settings(max_examples=30)
@pytest.mark.edge
def test_canonicalize_unknown_returns_none(snap: IRSnapshot):
...
@settings(max_examples=30)
@pytest.mark.edge
def test_canonicalize_wrong_snapshot_returns_none(snap: IRSnapshot):
...
@settings(max_examples=30)
@pytest.mark.edge
def test_get_aliases_wrong_snapshot_empty(snap: IRSnapshot):
...
@settings(max_examples=30)
@pytest.mark.edge
def test_resolve_symbol_wrong_snapshot_none(snap: IRSnapshot):
