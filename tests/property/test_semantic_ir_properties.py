...
class TestIRSnapshotProperties:
    ...
    @settings(max_examples=20)
    @pytest.mark.edge
    def test_snapshot_from_dict_missing_optional_keys(self, repo: str, snap_id: str):
    ...
    @settings(max_examples=20)
    @pytest.mark.edge
    def test_snapshot_from_dict_empty_lists(self, repo: str, snap_id: str):
    ...
    @settings(max_examples=20)
    @pytest.mark.edge
    def test_snapshot_empty_roundtrip(self, repo: str, snap_id: str):
