...
class TestContainmentEdges:
    ...
    @settings(max_examples=30)
    @pytest.mark.basic
    def test_every_symbol_gets_containment_edge_property(self, index: SCIPIndex, snap_id: str):
    ...
    @settings(max_examples=20)
    @pytest.mark.basic
    def test_containment_edge_source_is_scip_property(self, index: SCIPIndex, snap_id: str):
    ...
    @settings(max_examples=20)
    @pytest.mark.basic
    def test_containment_edge_confidence_precise_property(self, index: SCIPIndex, snap_id: str):
...
class TestOccurrenceProperties:
    ...
    @settings(max_examples=30)
    @pytest.mark.basic
    def test_all_occurrences_source_is_scip_property(self, index: SCIPIndex, snap_id: str):
    ...
    @settings(max_examples=30)
    @pytest.mark.basic
    def test_occurrence_symbol_ids_prefixed_property(self, index: SCIPIndex, snap_id: str):
    ...
    @settings(max_examples=20)
    @pytest.mark.basic
    def test_occurrence_metadata_has_scip_source_property(self, index: SCIPIndex, snap_id: str):
