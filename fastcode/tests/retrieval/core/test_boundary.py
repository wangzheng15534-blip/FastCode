...
class TestArchitectureBoundaries:
    ...
    def test_semantic_resolvers_do_not_import_infrastructure(self) -> None:
        """semantic/resolvers/ must not import from store/infrastructure/."""
        resolvers_dir = PACKAGE_DIR / "semantic" / "resolvers"
        assert resolvers_dir.exists(), (
            f"missing architecture directory: {resolvers_dir}"
        )
