...
class TestScipParsingProperties:
    ...
    @settings(max_examples=40)
    @pytest.mark.basic
    def test_scip_symbol_ids_follow_pattern_property(self, index: SCIPIndex, snap_id: str):
    ...
    @settings(max_examples=20)
    @pytest.mark.edge
    def test_build_ir_from_scip_symbol_empty_string_skipped_property(self, snap_id: str):
    ...
    @settings(max_examples=10)
    @pytest.mark.edge
    def test_build_ir_from_scip_occurrences_only_no_symbols_property(self, snap_id: str):
    ...
    @settings(max_examples=10)
    @pytest.mark.edge
    def test_build_ir_from_scip_duplicate_symbols_across_docs_property(self, snap_id: str):
